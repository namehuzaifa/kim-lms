...
Route::controller(SessionBookingController::class)->group(function (){
    ...
    Route::get('today-session-list/', 'index')->name('today-session-list')->middleware(['auth','user',]);
    Route::get('pending-session-list/', 'index')->name('pending-session-list')->middleware(['auth','user',]);
    Route::get('done-session-list/', 'index')->name('done-session-list')->middleware(['auth','user',]);

    Route::get('session-delete/{id}', 'destroy')->name('session-delete')->middleware(['auth','user',]);
...
Route::middleware(['auth','user', 'coach'])->group(function () {
